...
export const sampleMembers: Member[] = [
  {
    id: 'm-1', name: '田中', kana: 'たなか', postalCode: '000-0001', address: '兵庫県さくら市ひまわり町2-3（架空）',
  ...
  {
    id: 'm-2', name: '山田', kana: 'やまだ', postalCode: '000-0002', address: '兵庫県さくら市あおば町5-12（架空）',
  ...
  {
    id: 'm-3', name: '鈴木', kana: 'すずき', postalCode: '000-0003', address: '兵庫県さくら市かえで町1-8（架空）',
  ...
  {
    id: 'm-4', name: '佐藤', kana: 'さとう', postalCode: '000-0004', address: '兵庫県さくら市うめの台3-4（架空）',
  ...
  {
    id: 'm-5', name: '高橋', kana: 'たかはし', postalCode: '000-0005', address: '兵庫県さくら市きたやま2-1（架空）',
