...
import type { DayPlan, Facility, Member, RouteHistoryEntry, RoutePlan, Vehicle } from '../types';
  ...
  persist(
    ...
    }),
    {
      ...
      migrate: (state) => {
        ...
        return { ...s, dayPlan: null, activeRouteIndex: 0, history: s.history ?? [] } as AppState;
      },
      partialize: (s) => ({
        facility: s.facility,
        members: s.members,
